...
def _infer_prefix_and_remap(lora_weights, safetensor_keys):
    ...
    inherit default structures. Also handles reordered path components (Mistral 3 VLMs)
    via a dominant prefix-substitution rule learned from common-suffix matches.
